...
| -------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| Alex, janitor (`alex`)                             | Mopped the lobby all evening; anxious about the manager.                                                     | Stole the manager's gift liquor. From the office doorway, saw Sam discard a courier jacket, but stayed silent to conceal his own theft.                           | Present the manager's office photo (`photo`).                                                                      |
| Jordan, guard (`jordan`)                            | Watched the cameras the entire shift; terse and defensive.                                                   | Fell asleep and left his security terminal signed in. He did not see who used it.                                                                                   | Present the security inactivity log (`log`).                                                                       |
| Sam, customer and maintenance contractor (`sam`) | Came to collect an invoice; claims to have stayed in the public lobby. Polite, familiar, apparently helpful. | Learned Jordan's routine during repairs, used his unattended terminal to arrange a false cash pickup, and hired a runner who believed the collection was legitimate. | Present both the staff-corridor access record (`badge`) and courier pickup instructions (`heat`), in either order. |

Sam wore a courier jacket to make his presence look routine, then discarded it before the runner arrived. The runner is offscreen and is not a fourth interview suspect. Alex knows only what he saw; Jordan knows only his own lapse. Neither can supply Sam's plan or motive.
...
| `log`   | Security inactivity log      | No camera checks or patrol check-ins from Jordan between 17:55 and 18:06; terminal remained signed in and unlocked.                                           |
| `photo` | Manager's office photo       | Alex stole the gift bottle at 17:59, contradicting his lobby alibi and putting him at the corridor sightline.                                                |
| `badge` | Staff-corridor access record | Sam's E-17 pass entered at 18:01, contradicting his lobby alibi and placing him on the route to the security desk.                                         |
| `heat`  | Courier pickup instructions  | The security terminal booked the 18:04 pickup at 18:02 using Sam's verified E-17 account, directing the runner to deliver the cash to him behind the bank. |

Alex sees Sam discard the courier jacket at 18:03. The courier then collects the cash at 18:04. The investigation takes place after the robbery.
...
- A single proof clue makes Sam concede only that clue: corridor entry with `badge`, or the runner booking with `heat`. Both together unlock the full admission. The order does not matter, and disclosed information stays available for follow-up questions.
...
| 32–44s | Present the office photo to Alex. His separate theft explains his silence; his jacket sighting connects Sam to a disguise.                                            |
| 44–56s | Present the inactivity log to Jordan. His nap explains the opportunity and points to corridor access.                                                                    |
| 56–78s | Interview Sam. Present the corridor record for a limited concession, then the courier instructions for the full account.                                              |
| 78–90s | Submit Sam → planned the robbery / steal the cash → staff-corridor access record + courier pickup instructions. Close on “three secrets, one robbery.”                |
