...
Lucía waits outside the café, left of the main route toward the bank. Approach and press E. She is an optional witness, not a fourth suspect in the verdict menu. Her translation phone lifts during conversation; ask in English or Spanish to receive a Spanish reply with English captions. The panel identifies translation mode, supports larger captions, and offers optional browser Spanish speech. If the device has no Spanish voice, captions still work. Audio can be muted and stops when you leave. This is generated bilingual dialogue, not microphone speech recognition; no microphone access is needed. The same fact check also checks translation fidelity. Scripted fallback includes a matched authored translation. Existing saves gain her separate history without resetting the case.
